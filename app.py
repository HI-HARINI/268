...
def watercolor_effect(decode_array_to_img):
    watercolor_effect_img = cv2.stylization(decode_array_to_img, sigma_s = 60, sigma_r = 0.6)
    status, output_image = cv2.imencode('.PNG', watercolor_effect_img)
